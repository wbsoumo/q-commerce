    ...
    <div class="sidebar">
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column">
          ...
          <li class="nav-item"><a href="/admin/inventory/transactions" class="nav-link active"><i class="nav-icon fas fa-history"></i><p>Stock History</p></a></li>
          <li class="nav-item"><a href="/admin/inventory/alerts" class="nav-link"><i class="nav-icon fas fa-bell"></i><p>Stock Alerts</p></a></li>
        </ul>
      </nav>
    </div>
  </aside>
