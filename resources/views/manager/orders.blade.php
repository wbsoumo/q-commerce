...
<head>
  ...
  <title>Store Orders | {{ $store->name ?? 'Branch' }}</title>
  ...
  <div class="content-wrapper">
    <div class="content-header">
      <div class="container-fluid d-flex justify-content-between align-items-center">
        <div>
          <h1 class="m-0 font-weight-bold text-dark"><i class="fas fa-shopping-cart text-warning mr-2"></i>Store Orders</h1>
      ...
      <div class="container-fluid">
        ...
        <div class="card card-outline card-warning shadow-sm mb-4">
          <div class="card-header bg-warning text-dark d-flex justify-content-between align-items-center">
            <h3 class="card-title font-weight-bold my-1"><i class="fas fa-receipt mr-2"></i>Orders List & Lifecycle Control</h3>
          </div>
          <div class="card-body p-0">
            <table class="table table-striped table-bordered mb-0">
              ...
              <tbody>
                ...
                @empty
                <tr><td colspan="6" class="text-center py-4 text-muted">No orders found for this store.</td></tr>
                @endforelse
              </tbody>
            </table>
          </div>
